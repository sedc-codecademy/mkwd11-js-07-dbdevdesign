...
VALUES (
        ...
        'Stojanovski',
        (
            SELECT timestamp '1970-01-10 20:00:00' + random() * (
                    timestamp '1990-01-20 20:00:00' - timestamp '1970-01-10 10:00:00'
                )
        ),
        'M',
        (
            SELECT timestamp '2010-01-10 20:00:00' + random() * (
                    timestamp '1990-01-20 20:00:00' - timestamp '1985-01-10 10:00:00'
                )
        ),
        (
...
-- Orders
do $$ begin for counter in 1..100 by 1 loop
INSERT INTO "Order" (
        orderDate,
        status,
        businessEntityId,
...
VALUES (
        (
            SELECT timestamp '2018-01-01 20:00:00' + random() * (
                    timestamp '1990-01-20 20:00:00' - timestamp '1988-01-10 10:00:00'
                )
        ),
        0,
        (
            SELECT Id
            FROM businessentity OFFSET floor(
                    random() * (
                        SELECT COUNT(*)
                        FROM businessentity
                    )
...
-- Order details
do $$
declare orderRecord record;
begin for orderRecord in
select Id,
    totalprice
from "Order"
order by Id loop
...
VALUES (
        ...
        (
            ...
            LIMIT 1
        ), floor(random() * 100), orderRecord.totalPrice
    );
end loop;
end;
$$